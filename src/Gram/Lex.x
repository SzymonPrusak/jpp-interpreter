...
resWords =
  b "bool" 21
    ...
    (b "return" 32
       (b "fun" 27
          (b "else" 24
             (b "continue" 23 (b "break" 22 N N) N)
             (b "for" 26 (b "false" 25 N N) N))
          (b "new" 30 (b "int" 29 (b "if" 28 N N) N) (b "readonly" 31 N N)))
       (b "while" 37
          (b "true" 35 (b "to" 34 (b "string" 33 N N) N) (b "void" 36 N N))
          (b "}" 40 (b "||" 39 (b "{" 38 N N) N) (b "~(" 41 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
